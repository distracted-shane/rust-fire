...
mod tests { 
    ...
    async fn fn_path_string() {
        ...
        assert_eq!(FmcApi::Updates.path_string("123.23.3.1", dom_uuid).await,
        ...
        assert_eq!(FmcApi::Info.path_string("doctor.who", dom_uuid).await,
        ...
        assert_eq!(FmcApi::Tid.path_string("8.8.8.8", dom_uuid).await,
            "https://8.8.8.8:443/api/fmc_tid/v1/domain/f3b4958c-52a1-11e7-802a-010203040506/tid");
        
        // Inverse tests  
        assert_ne!(FmcApi::Tid.path_string("8.8.8.7", dom_uuid).await,
            "https://8.8.8.8:443/api/fmc_tid/v1/domain/f3b4958c-52a1-11e7-802a-010203040506/tid");
